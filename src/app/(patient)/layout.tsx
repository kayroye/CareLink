        ...
        <header className="sticky top-0 z-50 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm">
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <Link href="/my-referrals" className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-slate-800 dark:text-slate-100">ReferralLoop</span>
            </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                ...
                className="h-12 px-4 text-lg text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800"
              >
        ...
        <div className="max-w-4xl mx-auto px-6 py-3">
          <div className="flex justify-around items-center">
            ...
            >
              ...
              <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Callback</span>
            </Link>
